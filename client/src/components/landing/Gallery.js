...
const Gallery = () => {
  ...
  return (
    <ParallaxProvider>
      ...
      >
        <div className="text-center mb-6">
          <h1 className="text-2xl font-semibold md:text-4xl tracking-wide text-white">
            📸 Our Adventure <span className="text-primary">Gallery</span>
          </h1>
          <p className="text-lg text-secondary font-semibold">
            Explore breathtaking landscapes
        ...
        <div className="relative w-full md:w-3/4">
          ...
          >
            {images.map((image, index) => (
              <SwiperSlide key={index} className="relative overflow-hidden">
                <div className="relative w-full min-h-[35vh] md:min-h-[70vh] overflow-hidden rounded-lg shadow-lg">
                  <Parallax
                    speed={-10}
                    className="relative w-full h-[40vh] lg:h-[500px]"
                  >
